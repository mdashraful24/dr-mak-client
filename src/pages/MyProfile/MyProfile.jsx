...
const MyProfile = () => {
    ...
    // Show role-based message if no valid role
    if (!hasValidRole) {
        return (
            <div className="min-h-screen py-24 px-4">
                <title>{user?.name}'s Profile | dr mak</title>
                <div className="max-w-4xl mx-auto md:h-[calc(100vh-4rem)] flex items-center justify-center">
    ...
    if (error) {
        return (
            <div className="max-w-4xl mx-auto min-h-screen py-24 px-4">
                <title>{user?.name}'s Profile | dr mak</title>
