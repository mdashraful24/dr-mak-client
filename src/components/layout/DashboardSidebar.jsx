...
const DashboardSidebar = ({ isSidebarCollapsed, isSidebarOpen, toggleSidebar, onMenuItemClick }) => {
    const dashboardMenuItems = [
        ...
        { path: "/dashboard/patients-appointments-list", label: "AppointmentsList", icon: Calendar },
        { path: "/dashboard/patients-prescriptions-list", label: "Prescriptions", icon: Pill },
        { path: "/dashboard/patients-medical-records-list", label: "Medical Records", icon: FileText },
        { path: "/dashboard/patients-reports-list", label: "Reports", icon: BarChart3 },
        { path: "/dashboard/about-doctor", label: "Doctors", icon: Stethoscope },
